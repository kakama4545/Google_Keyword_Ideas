...
app.config['MYSQL_HOST'] = '195.179.236.52'
app.config['MYSQL_USER'] = 'u682243076_seoS98'
app.config['MYSQL_PASSWORD'] = '7m[Y1~MUAw.?@#'
app.config['MYSQL_DB'] = 'u682243076_seoD28'
app.config['MYSQL_PORT'] = 3306
app.config['MYSQL_SSL'] = {'sslmode': 'REQUIRED'}
mysql = MySQL(app)

# RapidAPI configurations
RAPIDAPI_KEY = 'c27a235904mshdae46716ad26840p1222fcjsnb0d056f0b6f5'
